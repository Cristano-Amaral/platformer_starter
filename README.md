...
- Milestone 61/71/72/73/74 gameplay SFX: `sounds/item_pickup_collect.wav`, `sounds/player_damage.wav`, `sounds/player_death.wav`, `sounds/player_respawn.wav`, `sounds/player_footstep.wav`, `sounds/player_jump.wav`, `sounds/player_land.wav`, `sounds/checkpoint_activate.wav`, `sounds/pressure_plate_activate.wav`, `sounds/pressure_plate_deactivate.wav`, `sounds/door_unlock.wav`, `sounds/level_goal_complete.wav`, `sounds/collectible_collect.wav`. Project-owned PCM WAVs; cook/stage; runtime never reads `source/`.
