...
The Development executable opens a resizable 1280x720 window titled `Platformer3D` with a 3D greybox scene. Use A/Left or D/Right to move along X, and Space or Up Arrow to jump. Greybox boxes are solid on top, sides and underside. Close the window or press ESC to exit.
