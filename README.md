...
Milestone 33 is complete and merged. Milestone 34 Phase B enabled the live X/Y/Z translation gizmo, pending ghost, `%LOCALAPPDATA%\Platformer3D\editor_layout.ini` persistence, and Reset Editor Layout. Phase C manual validation remains. Do not implement rotation/scale, add/delete, or Milestone 35.
...
.\build\windows-vs2022\Development\EditorGizmoTest.exe      # M34 axis drag math, pending preview, layout path
