...
Milestone 33 Phase B added live editor-camera navigation, Hierarchy, world picking, selection highlight, and Inspector routing. Editable types remain the M32 set; other hierarchy objects are read-only. Gizmos, add/delete, and Milestone 34 are out of scope. M33 is not complete until Phase C passes.
