...
Milestone 33 is complete and merged. Milestone 34 is complete and merged. Milestone 35 is complete and merged. Milestone 36 is complete and merged. Milestone 37 is complete and merged. Milestone 38 is complete and merged. Milestone 39 is complete and merged. Milestone 40 is complete and merged. Milestone 41 is complete and merged. Milestone 42 is complete and merged. Milestone 43 is implemented (Development Quick Toolbar below the menu bar; Translate/Resize share TransformMode; Apply/Revert/Save share LevelEditorRequest; build selector persists under `%LOCALAPPDATA%\Platformer3D\editor_build_selection.txt`; Run uses EditorToolRunner; viewport starts below the toolbar). Debug omits Build, Reload Runtime Level, the Edit lifecycle menu, Object Palette, and the Quick Toolbar. Awaiting manual acceptance. Do not implement Milestone 44.
