...
CANONICAL_FILES = (
    ...
    "docs/milestones/MILESTONE_95.md",
    "docs/milestones/MILESTONE_96.md",
    "docs/milestones/MILESTONE_97.md",
    "docs/milestones/MILESTONE_98.md",
    "docs/milestones/MILESTONE_99.md",
    "docs/milestones/MILESTONE_100.md",
...
class AgentInstructionTests(unittest.TestCase):
    ...
    def test_agents_routes_to_workflow_and_milestone(self) -> None:
        ...
        self.assertIn("docs/milestones/MILESTONE_104.md", text)
        self.assertIn("milestone/104-equipment-sockets-visible-equipment", text)
