...
**Status:** Implemented on `milestone/44-legacy-prototype-scene-cleanup`. Awaiting manual acceptance. Not complete. Milestone 45 has not started.\
...
M44 remains incomplete until manual acceptance is explicitly approved.


## Milestone 45

Not started. Do not implement during Milestone 44.
