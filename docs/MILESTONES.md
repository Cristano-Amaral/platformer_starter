...
**Status:** Implemented on `milestone/42-object-palette-placement`. Correction 1 applied (palette tool-toggle, Esc/click-again exit, gizmo pointer block, surface vs fallback preview). Awaiting manual acceptance. Not complete. Milestone 43 has not started.\
...
Not started. Do not implement during Milestone 42.
